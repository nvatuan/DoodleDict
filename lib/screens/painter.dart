...
class PainterController extends ChangeNotifier {
  ...
  // PainterController(this._backgroundColor, this._cached,
  // this._drawColor, this._eraseMode, this._pathHistory,
  // this._thickness, this._widgetFinish)

  // PainterController.clone(PainterController obj)
  //     : this(obj._backgroundColor, obj._cached, obj._drawColor, obj._eraseMode,
  //           obj._pathHistory, obj._thickness, obj._widgetFinish);
  PainterController.clone(PainterController obj) {
    this._backgroundColor = obj._backgroundColor;
    this._cached = obj._cached;
    this._drawColor = obj._drawColor;
    this._eraseMode = obj._eraseMode;
    this._pathHistory = obj._pathHistory;
    this._thickness = obj._thickness;
    this._widgetFinish = obj._widgetFinish;
  }
